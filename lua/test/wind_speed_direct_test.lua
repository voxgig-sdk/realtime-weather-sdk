...
describe("WindSpeedDirect", function()
  it("should direct-list-wind_speed", function()
    local setup = wind_speed_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-wind_speed", setup.live and "live" or "unit")
