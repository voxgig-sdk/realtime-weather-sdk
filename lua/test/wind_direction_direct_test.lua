...
describe("WindDirectionDirect", function()
  it("should direct-list-wind_direction", function()
    local setup = wind_direction_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-wind_direction", setup.live and "live" or "unit")
