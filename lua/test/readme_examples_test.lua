...
local SDK_MODULE = "realtime-weather_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["air_temperature"] = { ["test01"] = { id = "test01" } }, ["collection"] = { ["test01"] = { id = "test01" } }, ["rainfall"] = { ["test01"] = { id = "test01" } }, ["relative_humidity"] = { ["test01"] = { id = "test01" } }, ["wind_direction"] = { ["test01"] = { id = "test01" } }, ["wind_speed"] = { ["test01"] = { id = "test01" } } } }'
