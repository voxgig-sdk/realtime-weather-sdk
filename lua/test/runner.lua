...
function runner.env_override(m)
  local live = runner.getenv("REALTIMEWEATHER_TEST_LIVE")
  local override = runner.getenv("REALTIMEWEATHER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("REALTIMEWEATHER_TEST_EXPLAIN")
