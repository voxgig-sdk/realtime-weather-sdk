...
function runner.env_override(m)
  local live = runner.getenv("REALTIME_WEATHER_TEST_LIVE")
  local override = runner.getenv("REALTIME_WEATHER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("REALTIME_WEATHER_TEST_EXPLAIN")
