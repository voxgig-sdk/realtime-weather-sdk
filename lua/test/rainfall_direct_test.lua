...
describe("RainfallDirect", function()
  it("should direct-list-rainfall", function()
    local setup = rainfall_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-rainfall", setup.live and "live" or "unit")
