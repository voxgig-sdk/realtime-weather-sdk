...
describe("AirTemperatureDirect", function()
  it("should direct-list-air_temperature", function()
    local setup = air_temperature_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-air_temperature", setup.live and "live" or "unit")
