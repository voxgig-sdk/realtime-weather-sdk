...
local WindSpeedEntity = {}
WindSpeedEntity.__index = WindSpeedEntity


function WindSpeedEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WindSpeedEntity)
...
function WindSpeedEntity:get_name()
  return self._name
end


function WindSpeedEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WindSpeedEntity.new(self._client, opts)
end
...
function WindSpeedEntity:mark_deleted()
  self._deleted = true
end


function WindSpeedEntity:deleted()
  return true == self._deleted
end


function WindSpeedEntity:data_set(args)
  if args ~= nil then
...
function WindSpeedEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WindSpeedEntity:match_set(args)
  if args ~= nil then
...
function WindSpeedEntity:match_get()
...
function WindSpeedEntity:stream(action, args, callopts)
...
function WindSpeedEntity:_run_op(ctx, post_done)
  local utility = self._utility
