...
local AirTemperatureEntity = {}
AirTemperatureEntity.__index = AirTemperatureEntity


function AirTemperatureEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AirTemperatureEntity)
  self._name = "air_temperature"
  self._client = client
...
function AirTemperatureEntity:get_name()
  return self._name
end


function AirTemperatureEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AirTemperatureEntity.new(self._client, opts)
end
...
function AirTemperatureEntity:mark_deleted()
  self._deleted = true
end


function AirTemperatureEntity:deleted()
  return true == self._deleted
end


function AirTemperatureEntity:data_set(args)
  if args ~= nil then
...
function AirTemperatureEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AirTemperatureEntity:match_set(args)
  if args ~= nil then
...
function AirTemperatureEntity:match_get()
...
function AirTemperatureEntity:stream(action, args, callopts)
...
function AirTemperatureEntity:_run_op(ctx, post_done)
  local utility = self._utility
