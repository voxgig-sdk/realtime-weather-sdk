...
local WindDirectionEntity = {}
WindDirectionEntity.__index = WindDirectionEntity


function WindDirectionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WindDirectionEntity)
...
function WindDirectionEntity:get_name()
  return self._name
end


function WindDirectionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WindDirectionEntity.new(self._client, opts)
end
...
function WindDirectionEntity:mark_deleted()
  self._deleted = true
end


function WindDirectionEntity:deleted()
  return true == self._deleted
end


function WindDirectionEntity:data_set(args)
  if args ~= nil then
...
function WindDirectionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WindDirectionEntity:match_set(args)
  if args ~= nil then
...
function WindDirectionEntity:match_get()
...
function WindDirectionEntity:stream(action, args, callopts)
...
function WindDirectionEntity:_run_op(ctx, post_done)
  local utility = self._utility
