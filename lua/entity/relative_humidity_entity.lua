-- RealtimeWeather SDK RelativeHumidity entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local RelativeHumidityEntity = {}
RelativeHumidityEntity.__index = RelativeHumidityEntity


function RelativeHumidityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RelativeHumidityEntity)
  self._name = "relative_humidity"
  self._client = client
...
function RelativeHumidityEntity:get_name()
  return self._name
end


function RelativeHumidityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RelativeHumidityEntity.new(self._client, opts)
end
...
function RelativeHumidityEntity:mark_deleted()
  self._deleted = true
end


function RelativeHumidityEntity:deleted()
  return true == self._deleted
end


function RelativeHumidityEntity:data_set(args)
  if args ~= nil then
...
function RelativeHumidityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RelativeHumidityEntity:match_set(args)
  if args ~= nil then
...
function RelativeHumidityEntity:match_get()
...
function RelativeHumidityEntity:stream(action, args, callopts)
...
function RelativeHumidityEntity:_run_op(ctx, post_done)
  local utility = self._utility
