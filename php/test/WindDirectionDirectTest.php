...
class WindDirectionDirectTest extends TestCase
{
    public function test_direct_list_wind_direction(): void
    {
        $setup = wind_direction_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-wind_direction", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function wind_direction_direct_setup($mockres)
{
