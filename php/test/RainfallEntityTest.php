...
class RainfallEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->Rainfall(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->Rainfall(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set REALTIME_WEATHER_TEST_RAINFALL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function rainfall_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("REALTIME_WEATHER_TEST_RAINFALL_ENTID");
