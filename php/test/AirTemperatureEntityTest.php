...
class AirTemperatureEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->AirTemperature(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->AirTemperature(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set REALTIME_WEATHER_TEST_AIR_TEMPERATURE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function air_temperature_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("REALTIME_WEATHER_TEST_AIR_TEMPERATURE_ENTID");
