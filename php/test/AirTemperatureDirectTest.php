...
class AirTemperatureDirectTest extends TestCase
{
    public function test_direct_list_air_temperature(): void
    {
        $setup = air_temperature_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-air_temperature", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function air_temperature_direct_setup($mockres)
{
