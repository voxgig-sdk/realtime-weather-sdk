...
class RainfallDirectTest extends TestCase
{
    public function test_direct_list_rainfall(): void
    {
        $setup = rainfall_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-rainfall", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function rainfall_direct_setup($mockres)
{
