...
class CollectionEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set REALTIMEWEATHER_TEST_COLLECTION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function collection_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("REALTIMEWEATHER_TEST_COLLECTION_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["REALTIMEWEATHER_TEST_COLLECTION_ENTID"]);
