...
// RealtimeWeather SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RealtimeWeatherSDK::test)
...
{
    private const SDK_CLASS = 'RealtimeWeatherSDK';
    ...
    private const SDK_BASE = 'realtimeweather_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../realtimeweather_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
