...
class RelativeHumidityDirectTest extends TestCase
{
    public function test_direct_list_relative_humidity(): void
    {
        $setup = relative_humidity_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-relative_humidity", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
