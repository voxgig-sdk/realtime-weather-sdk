...
class RelativeHumidityEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set REALTIMEWEATHER_TEST_RELATIVE_HUMIDITY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function relative_humidity_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("REALTIMEWEATHER_TEST_RELATIVE_HUMIDITY_ENTID");
