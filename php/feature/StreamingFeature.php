...
// RealtimeWeather SDK streaming feature
...
class RealtimeWeatherStreamingFeature extends RealtimeWeatherBaseFeature
{
    ...
    private function _iterate(RealtimeWeatherResult $result): \Generator
    {
    ...
    private function _streamable(RealtimeWeatherContext $ctx): bool
    {
