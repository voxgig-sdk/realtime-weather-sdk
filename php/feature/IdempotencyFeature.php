...
// RealtimeWeather SDK idempotency feature
...
class RealtimeWeatherIdempotencyFeature extends RealtimeWeatherBaseFeature
{
    ...
    private function _mutating(RealtimeWeatherContext $ctx): bool
    {
