...
// RealtimeWeather SDK paging feature
...
class RealtimeWeatherPagingFeature extends RealtimeWeatherBaseFeature
{
    ...
    private function _is_list(RealtimeWeatherContext $ctx): bool
    {
