...
// RealtimeWeather SDK clienttrack feature
...
class RealtimeWeatherClienttrackFeature extends RealtimeWeatherBaseFeature
{
    ...
    public function PostConstruct(RealtimeWeatherContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RealtimeWeather-SDK';
