...
// RealtimeWeather SDK ratelimit feature
...
class RealtimeWeatherRatelimitFeature extends RealtimeWeatherBaseFeature
{
    ...
    private function _acquire(RealtimeWeatherContext $ctx): void
    {
    ...
    private function _track(RealtimeWeatherContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
