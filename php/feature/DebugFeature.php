...
// RealtimeWeather SDK debug feature
...
class RealtimeWeatherDebugFeature extends RealtimeWeatherBaseFeature
{
    ...
    private function _finish(RealtimeWeatherContext $ctx, bool $ok): void
    {
