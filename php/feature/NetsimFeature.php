...
// RealtimeWeather SDK netsim feature
...
class RealtimeWeatherNetsimFeature extends RealtimeWeatherBaseFeature
{
    ...
    private function _simulate(RealtimeWeatherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RealtimeWeatherContext $ctx, array $applied): void
    {
        $client = $this->client;
