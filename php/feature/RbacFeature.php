...
// RealtimeWeather SDK rbac feature
...
class RealtimeWeatherRbacFeature extends RealtimeWeatherBaseFeature
{
    ...
    private function _required(RealtimeWeatherContext $ctx): ?string
    {
    ...
    private function _reject(RealtimeWeatherContext $ctx, string $required): void
    {
    ...
    private function _track(RealtimeWeatherContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
