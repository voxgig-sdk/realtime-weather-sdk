...
// RealtimeWeather SDK timeout feature
...
class RealtimeWeatherTimeoutFeature extends RealtimeWeatherBaseFeature
{
    ...
    private function _with_timeout(RealtimeWeatherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RealtimeWeatherContext $_ctx, float $ms): void
    {
        $client = $this->client;
