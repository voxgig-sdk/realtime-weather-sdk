...
The PHP SDK for the RealtimeWeather API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->AirTemperature(null)->list(null, null);
...
[$result, $err] = $client->RealtimeWeather(null)->load(
    ["id" => "test01"], null
);
