...
// RealtimeWeather SDK WindDirection entity
...
class WindDirectionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WindDirectionEntity($this->_client, $opts);
    }

    /**
     * @param WindDirection|array $args WindDirection data (assoc-array) to store.
     */
    ...
    /**
     * @return WindDirection|array The current WindDirection data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WindDirection fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WindDirection fields).
     */
    ...
    /**
     * List WindDirection items matching the given filter.
     *
     * @param WindDirectionListMatch|array|null $reqmatch Match filter (any subset
     *   of WindDirection fields) as an assoc-array; WindDirectionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WindDirection[]|array A list of WindDirection items as assoc-arrays at
