...
// RealtimeWeather SDK WindSpeed entity
...
class WindSpeedEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WindSpeedEntity($this->_client, $opts);
    }

    /**
     * @param WindSpeed|array $args WindSpeed data (assoc-array) to store.
     */
    ...
    /**
     * @return WindSpeed|array The current WindSpeed data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WindSpeed fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WindSpeed fields).
     */
    ...
    /**
     * List WindSpeed items matching the given filter.
     *
     * @param WindSpeedListMatch|array|null $reqmatch Match filter (any subset
     *   of WindSpeed fields) as an assoc-array; WindSpeedListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WindSpeed[]|array A list of WindSpeed items as assoc-arrays at
