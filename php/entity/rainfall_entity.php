...
// RealtimeWeather SDK Rainfall entity
...
class RainfallEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RainfallEntity($this->_client, $opts);
    }

    /**
     * @param Rainfall|array $args Rainfall data (assoc-array) to store.
     */
    ...
    /**
     * @return Rainfall|array The current Rainfall data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Rainfall fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Rainfall fields).
     */
    ...
    /**
     * List Rainfall items matching the given filter.
     *
     * @param RainfallListMatch|array|null $reqmatch Match filter (any subset
     *   of Rainfall fields) as an assoc-array; RainfallListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Rainfall[]|array A list of Rainfall items as assoc-arrays at
