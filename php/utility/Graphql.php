...
// RealtimeWeather SDK utility: graphql
//
...
class RealtimeWeatherGraphql
{
    ...
    // equivalent.
    public static function body(RealtimeWeatherContext $ctx): mixed
    {
    ...
    public static function errors(RealtimeWeatherContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
