...
// RealtimeWeather SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class RealtimeWeatherMakeRequest
{
    public static function call(RealtimeWeatherContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new RealtimeWeatherResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new RealtimeWeatherResponse($fetched);
        } else {
