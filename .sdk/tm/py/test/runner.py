...
class RealtimeWeatherTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RealtimeWeatherTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = RealtimeWeatherTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = RealtimeWeatherTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
