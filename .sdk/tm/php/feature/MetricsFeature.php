...
// RealtimeWeather SDK metrics feature
...
class RealtimeWeatherMetricsFeature extends RealtimeWeatherBaseFeature
{
    ...
    private function _record(RealtimeWeatherContext $ctx, bool $ok): void
    {
