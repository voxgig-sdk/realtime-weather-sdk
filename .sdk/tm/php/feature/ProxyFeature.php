...
// RealtimeWeather SDK proxy feature
...
class RealtimeWeatherProxyFeature extends RealtimeWeatherBaseFeature
{
    ...
    public function init(RealtimeWeatherContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RealtimeWeatherContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
