...
// RealtimeWeather SDK cache feature
...
class RealtimeWeatherCacheFeature extends RealtimeWeatherBaseFeature
{
    ...
    private function _through(RealtimeWeatherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
