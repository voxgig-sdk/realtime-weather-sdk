...
// RealtimeWeather SDK audit feature
...
class RealtimeWeatherAuditFeature extends RealtimeWeatherBaseFeature
{
    ...
    private function _emit(RealtimeWeatherContext $ctx, string $outcome): void
    {
