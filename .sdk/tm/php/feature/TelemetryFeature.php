...
// RealtimeWeather SDK telemetry feature
...
class RealtimeWeatherTelemetryFeature extends RealtimeWeatherBaseFeature
{
    ...
    private function _close(RealtimeWeatherContext $ctx, bool $ok): void
    {
