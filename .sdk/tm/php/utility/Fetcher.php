...
// RealtimeWeather SDK utility: fetcher
...
class RealtimeWeatherFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RealtimeWeatherSDK/1.0)';
    ...
    public static function call(RealtimeWeatherContext $ctx, string $fullurl, array $fetchdef): array
    {
