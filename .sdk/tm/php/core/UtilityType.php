...
// RealtimeWeather SDK utility type

class RealtimeWeatherUtility
{
    ...
    public static function copy(RealtimeWeatherUtility $src): RealtimeWeatherUtility
    {
        $u = new RealtimeWeatherUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
