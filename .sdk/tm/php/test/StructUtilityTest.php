...
// RealtimeWeather SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = RealtimeWeatherOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(RealtimeWeatherOmni::structfix($now, Struct::undef()))
                        !== json_encode(RealtimeWeatherOmni::structfix($val, Struct::undef()))) {
