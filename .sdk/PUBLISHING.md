...
|---|---|---|
| `ts/` | @voxgig-sdk/realtime-weather-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/realtime-weather-sdk \
      --repository voxgig-sdk/realtime-weather-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/realtime-weather-sdk` shows it, and
`npm trust revoke @voxgig-sdk/realtime-weather-sdk --id=<id>` removes it.
