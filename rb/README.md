...
The Ruby SDK for the RealtimeWeather API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.RealtimeWeather(nil).load(
  { "id" => "test01" }, nil
)
