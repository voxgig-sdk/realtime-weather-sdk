...
class WindSpeedEntity
  ...
  def make
    opts = @_entopts.dup
    WindSpeedEntity.new(@_client, opts)
  end
  ...
  # @return [WindSpeed, Hash] the current WindSpeed data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of WindSpeed fields)
  def match_get
  ...
  #
  # @param reqmatch [WindSpeedListMatch, Hash, nil] match filter (any subset of
  #   WindSpeed fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<WindSpeed>, Array] the matching WindSpeed items; raises RealtimeWeatherError on failure
