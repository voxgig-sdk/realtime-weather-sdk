...
class WindDirectionEntity
  ...
  def make
    opts = @_entopts.dup
    WindDirectionEntity.new(@_client, opts)
  end
  ...
  # @return [WindDirection, Hash] the current WindDirection data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of WindDirection fields)
  def match_get
  ...
  #
  # @param reqmatch [WindDirectionListMatch, Hash, nil] match filter (any subset of
  #   WindDirection fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<WindDirection>, Array] the matching WindDirection items; raises RealtimeWeatherError on failure
