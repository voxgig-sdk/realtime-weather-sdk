...
class RelativeHumidityEntity
  ...
  def make
    opts = @_entopts.dup
    RelativeHumidityEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [RelativeHumidityListMatch, Hash, nil] match filter (any subset of
  #   RelativeHumidity fields); defaults to nil, treated as an empty match that lists all.
