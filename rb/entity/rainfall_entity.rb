...
class RainfallEntity
  ...
  def make
    opts = @_entopts.dup
    RainfallEntity.new(@_client, opts)
  end
  ...
  # @return [Rainfall, Hash] the current Rainfall data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Rainfall fields)
  def match_get
  ...
  #
  # @param reqmatch [RainfallListMatch, Hash, nil] match filter (any subset of
  #   Rainfall fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Rainfall>, Array] the matching Rainfall items; raises RealtimeWeatherError on failure
