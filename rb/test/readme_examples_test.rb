...
#      offline in seeded test mode (RealtimeWeatherSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "RealtimeWeather_sdk.rb")
  SDK_CLASS = "RealtimeWeatherSDK"
