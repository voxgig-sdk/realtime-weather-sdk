...
class RainfallEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set REALTIMEWEATHER_TEST_RAINFALL_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def rainfall_basic_setup(extra)
  ...
  entid_env_raw = ENV["REALTIMEWEATHER_TEST_RAINFALL_ENTID"]
