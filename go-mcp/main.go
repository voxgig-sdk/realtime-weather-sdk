// Command RealtimeWeather-mcp is an MCP server exposing the RealtimeWeather
// SDK as MCP tools.
//
// Two tools are registered:
//
//	RealtimeWeather_list  — list records of an entity
//	RealtimeWeather_load  — load a single record of an entity
//
