...
func registerSDKWords(r *eng.Registry, client *sdk.RealtimeWeatherSDK) {
...
func runOp(client *sdk.RealtimeWeatherSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
