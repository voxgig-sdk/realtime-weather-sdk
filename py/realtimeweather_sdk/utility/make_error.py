...
def make_error_util(ctx, err):
    if ctx is None:
        from realtimeweather_sdk.core.context import RealtimeWeatherContext
        ctx = RealtimeWeatherContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, RealtimeWeatherError):
        errmsg = err.msg
    ...
    sdk_err = RealtimeWeatherError("", msg, ctx)
