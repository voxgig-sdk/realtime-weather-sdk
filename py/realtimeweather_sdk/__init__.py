...
from realtimeweather_sdk.utility import register

# Load features
from realtimeweather_sdk.feature.base_feature import RealtimeWeatherBaseFeature
from realtimeweather_sdk.features import _has_feature, _make_feature
...
class RealtimeWeatherSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = RealtimeWeatherUtility()
    ...
    def get_utility(self):
        return RealtimeWeatherUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "RealtimeWeatherSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RealtimeWeatherSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def AirTemperature(self, data=None) -> "AirTemperatureEntity":
        ...
        from realtimeweather_sdk.entity.air_temperature_entity import AirTemperatureEntity
    ...
    def Collection(self, data=None) -> "CollectionEntity":
        ...
        from realtimeweather_sdk.entity.collection_entity import CollectionEntity
    ...
    def Rainfall(self, data=None) -> "RainfallEntity":
        ...
        from realtimeweather_sdk.entity.rainfall_entity import RainfallEntity
    ...
    def RelativeHumidity(self, data=None) -> "RelativeHumidityEntity":
        ...
        from realtimeweather_sdk.entity.relative_humidity_entity import RelativeHumidityEntity
    ...
    def WindDirection(self, data=None) -> "WindDirectionEntity":
        ...
        from realtimeweather_sdk.entity.wind_direction_entity import WindDirectionEntity
    ...
    def WindSpeed(self, data=None) -> "WindSpeedEntity":
        ...
        from realtimeweather_sdk.entity.wind_speed_entity import WindSpeedEntity
