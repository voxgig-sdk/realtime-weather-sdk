...
from realtimeweather_sdk.realtimeweather_types import (
    RelativeHumidity,
    RelativeHumidityListMatch,
)


class RelativeHumidityEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RelativeHumidityEntity(self._client, opts)
    ...
    def data_get(self) -> RelativeHumidity:
    ...
    def match_get(self) -> RelativeHumidity:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[RelativeHumidity]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.RelativeHumidity().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
