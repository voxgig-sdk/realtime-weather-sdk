...
class AirTemperatureEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AirTemperatureEntity(self._client, opts)
    ...
    def data_get(self) -> AirTemperature:
    ...
    def match_get(self) -> AirTemperature:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AirTemperature]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AirTemperature().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
