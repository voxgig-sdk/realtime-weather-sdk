# RealtimeWeather SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RealtimeWeatherSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RealtimeWeatherSDK(...) and RealtimeWeatherSDK.test(...) become
#      RealtimeWeatherSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "realtimeweather_sdk"
_SDK_CLASS = "RealtimeWeatherSDK"
