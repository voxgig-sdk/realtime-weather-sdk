...
The Python SDK for the RealtimeWeather API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.AirTemperature()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/realtime-weather-sdk/releases)) or
...
| Field | Type | Description |
| --- | --- | --- |
| `coverage` | `str` | Time coverage of the dataset |
| `datasetId` | `str` | Unique identifier for the dataset |
| `id` | `str` |  |
