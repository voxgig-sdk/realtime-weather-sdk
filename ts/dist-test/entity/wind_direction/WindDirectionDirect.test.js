...
(0, node_test_1.describe)('WindDirectionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-wind_direction', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-wind_direction', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['REALTIME_WEATHER_TEST_WIND_DIRECTION_ENTID'];
...
//# sourceMappingURL=WindDirectionDirect.test.js.map