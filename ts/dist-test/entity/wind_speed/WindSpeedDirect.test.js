...
(0, node_test_1.describe)('WindSpeedDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.RealtimeWeatherSDK({
    ...
    (0, node_test_1.test)('direct-list-wind_speed', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-wind_speed', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["collection01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.RealtimeWeatherSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['REALTIME_WEATHER_TEST_WIND_SPEED_ENTID'];
    ...
    const client = new __1.RealtimeWeatherSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=WindSpeedDirect.test.js.map