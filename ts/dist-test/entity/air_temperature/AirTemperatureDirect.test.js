...
(0, node_test_1.describe)('AirTemperatureDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-air_temperature', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-air_temperature', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['REALTIME_WEATHER_TEST_AIR_TEMPERATURE_ENTID'];
...
//# sourceMappingURL=AirTemperatureDirect.test.js.map