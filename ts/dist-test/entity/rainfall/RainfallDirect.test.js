...
(0, node_test_1.describe)('RainfallDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-rainfall', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-rainfall', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'REALTIME_WEATHER_TEST_RAINFALL_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['REALTIME_WEATHER_TEST_RAINFALL_ENTID'];
...
//# sourceMappingURL=RainfallDirect.test.js.map