...
describe('RelativeHumidityDirect', async () => {
  ...
  test('direct-list-relative_humidity', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-relative_humidity', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['REALTIME_WEATHER_TEST_RELATIVE_HUMIDITY_ENTID']
