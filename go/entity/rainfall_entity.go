...
func NewRainfallEntity(client *core.RealtimeWeatherSDK, entopts map[string]any) *RainfallEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RainfallEntity) GetName() string { return e.name }
...
func (e *RainfallEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RainfallEntity) Deleted() bool {
	return e.deleted
}


func (e *RainfallEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRainfallEntity(e.client, opts)
}

func (e *RainfallEntity) Data(args ...any) any {
...
func (e *RainfallEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Rainfall; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RainfallEntity) DataTyped(data ...Rainfall) Rainfall {
	if len(data) > 0 {
		return typedFrom[Rainfall](e.Data(asMap(data[0])))
	}
	return typedFrom[Rainfall](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Rainfall (all fields
// optional at the wire level).
func (e *RainfallEntity) MatchTyped(match ...Rainfall) Rainfall {
	if len(match) > 0 {
		return typedFrom[Rainfall](e.Match(asMap(match[0])))
	}
	return typedFrom[Rainfall](e.Match())
}
...
func (e *RainfallEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RainfallEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RainfallEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RainfallListMatch and returns []Rainfall. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RainfallEntity) ListTyped(reqmatch RainfallListMatch, ctrl map[string]any) ([]Rainfall, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Rainfall](res), nil
}



func (e *RainfallEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RainfallEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RainfallEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RainfallEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
