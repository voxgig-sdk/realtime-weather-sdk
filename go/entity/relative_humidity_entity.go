...
type RelativeHumidityEntity struct {
	name    string
	client  *core.RealtimeWeatherSDK
...
func NewRelativeHumidityEntity(client *core.RealtimeWeatherSDK, entopts map[string]any) *RelativeHumidityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RelativeHumidityEntity) GetName() string { return e.name }
...
func (e *RelativeHumidityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RelativeHumidityEntity) Deleted() bool {
	return e.deleted
}


func (e *RelativeHumidityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRelativeHumidityEntity(e.client, opts)
}

func (e *RelativeHumidityEntity) Data(args ...any) any {
...
func (e *RelativeHumidityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RelativeHumidity; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RelativeHumidityEntity) DataTyped(data ...RelativeHumidity) RelativeHumidity {
	if len(data) > 0 {
		return typedFrom[RelativeHumidity](e.Data(asMap(data[0])))
	}
	return typedFrom[RelativeHumidity](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RelativeHumidity (all fields
// optional at the wire level).
func (e *RelativeHumidityEntity) MatchTyped(match ...RelativeHumidity) RelativeHumidity {
	if len(match) > 0 {
		return typedFrom[RelativeHumidity](e.Match(asMap(match[0])))
	}
	return typedFrom[RelativeHumidity](e.Match())
}
...
func (e *RelativeHumidityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RelativeHumidityEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RelativeHumidityEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RelativeHumidityListMatch and returns []RelativeHumidity. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RelativeHumidityEntity) ListTyped(reqmatch RelativeHumidityListMatch, ctrl map[string]any) ([]RelativeHumidity, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[RelativeHumidity](res), nil
}



func (e *RelativeHumidityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RelativeHumidityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RelativeHumidityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RelativeHumidityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
