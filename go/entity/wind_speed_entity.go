...
func NewWindSpeedEntity(client *core.RealtimeWeatherSDK, entopts map[string]any) *WindSpeedEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WindSpeedEntity) GetName() string { return e.name }
...
func (e *WindSpeedEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WindSpeedEntity) Deleted() bool {
	return e.deleted
}


func (e *WindSpeedEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWindSpeedEntity(e.client, opts)
}

func (e *WindSpeedEntity) Data(args ...any) any {
...
func (e *WindSpeedEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WindSpeed; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WindSpeedEntity) DataTyped(data ...WindSpeed) WindSpeed {
	if len(data) > 0 {
		return typedFrom[WindSpeed](e.Data(asMap(data[0])))
	}
	return typedFrom[WindSpeed](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WindSpeed (all fields
// optional at the wire level).
func (e *WindSpeedEntity) MatchTyped(match ...WindSpeed) WindSpeed {
	if len(match) > 0 {
		return typedFrom[WindSpeed](e.Match(asMap(match[0])))
	}
	return typedFrom[WindSpeed](e.Match())
}
...
func (e *WindSpeedEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WindSpeedEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *WindSpeedEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WindSpeedListMatch and returns []WindSpeed. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *WindSpeedEntity) ListTyped(reqmatch WindSpeedListMatch, ctrl map[string]any) ([]WindSpeed, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[WindSpeed](res), nil
}



func (e *WindSpeedEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WindSpeedEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WindSpeedEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WindSpeedEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
