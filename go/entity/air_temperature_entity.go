...
type AirTemperatureEntity struct {
	name    string
...
func NewAirTemperatureEntity(client *core.RealtimeWeatherSDK, entopts map[string]any) *AirTemperatureEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AirTemperatureEntity) GetName() string { return e.name }
...
func (e *AirTemperatureEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AirTemperatureEntity) Deleted() bool {
	return e.deleted
}


func (e *AirTemperatureEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAirTemperatureEntity(e.client, opts)
}

func (e *AirTemperatureEntity) Data(args ...any) any {
...
func (e *AirTemperatureEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AirTemperature; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AirTemperatureEntity) DataTyped(data ...AirTemperature) AirTemperature {
	if len(data) > 0 {
		return typedFrom[AirTemperature](e.Data(asMap(data[0])))
	}
	return typedFrom[AirTemperature](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AirTemperature (all fields
// optional at the wire level).
func (e *AirTemperatureEntity) MatchTyped(match ...AirTemperature) AirTemperature {
	if len(match) > 0 {
		return typedFrom[AirTemperature](e.Match(asMap(match[0])))
	}
	return typedFrom[AirTemperature](e.Match())
}
...
func (e *AirTemperatureEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AirTemperatureEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AirTemperatureEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AirTemperatureListMatch and returns []AirTemperature. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AirTemperatureEntity) ListTyped(reqmatch AirTemperatureListMatch, ctrl map[string]any) ([]AirTemperature, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[AirTemperature](res), nil
}



func (e *AirTemperatureEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AirTemperatureEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AirTemperatureEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AirTemperatureEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
