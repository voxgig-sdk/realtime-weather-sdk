...
type WindDirectionEntity struct {
	name    string
...
func NewWindDirectionEntity(client *core.RealtimeWeatherSDK, entopts map[string]any) *WindDirectionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WindDirectionEntity) GetName() string { return e.name }
...
func (e *WindDirectionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WindDirectionEntity) Deleted() bool {
	return e.deleted
}


func (e *WindDirectionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWindDirectionEntity(e.client, opts)
}

func (e *WindDirectionEntity) Data(args ...any) any {
...
func (e *WindDirectionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WindDirection; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WindDirectionEntity) DataTyped(data ...WindDirection) WindDirection {
	if len(data) > 0 {
		return typedFrom[WindDirection](e.Data(asMap(data[0])))
	}
	return typedFrom[WindDirection](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WindDirection (all fields
// optional at the wire level).
func (e *WindDirectionEntity) MatchTyped(match ...WindDirection) WindDirection {
	if len(match) > 0 {
		return typedFrom[WindDirection](e.Match(asMap(match[0])))
	}
	return typedFrom[WindDirection](e.Match())
}
...
func (e *WindDirectionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WindDirectionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *WindDirectionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WindDirectionListMatch and returns []WindDirection. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *WindDirectionEntity) ListTyped(reqmatch WindDirectionListMatch, ctrl map[string]any) ([]WindDirection, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[WindDirection](res), nil
}



func (e *WindDirectionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WindDirectionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WindDirectionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WindDirectionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
