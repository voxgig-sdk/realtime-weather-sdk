...
The Golang SDK for the RealtimeWeather API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/realtime-weather-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/realtime-weather-sdk=../path/to/github.com/voxgig-sdk/realtime-weather-sdk
```
...
Create an instance: `air_temperature := client.AirTemperature(nil)`
...
Create an instance: `relative_humidity := client.RelativeHumidity(nil)`
...
Create an instance: `wind_direction := client.WindDirection(nil)`
...
Create an instance: `wind_speed := client.WindSpeed(nil)`
...
```
github.com/voxgig-sdk/realtime-weather-sdk/
...
The root package (`github.com/voxgig-sdk/realtime-weather-sdk`) re-exports everything needed
