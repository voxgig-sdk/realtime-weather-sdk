...
const testSeed = `map[string]any{"entity": map[string]any{"air_temperature": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "collection": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rainfall": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "relative_humidity": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "wind_direction": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "wind_speed": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
