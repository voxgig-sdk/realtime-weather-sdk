...
type RealtimeWeatherSDK struct {
	Mode     string
...
func (sdk *RealtimeWeatherSDK) OptionsMap() map[string]any {
...
func (sdk *RealtimeWeatherSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *RealtimeWeatherSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *RealtimeWeatherSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RealtimeWeatherSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *RealtimeWeatherSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *RealtimeWeatherSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("RealtimeWeatherSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *RealtimeWeatherSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RealtimeWeatherSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("RealtimeWeatherSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *RealtimeWeatherSDK {
	...
	sdk := NewRealtimeWeatherSDK(sdkopts)
	sdk.Mode = "test"
