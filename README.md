...
This API provides real-time readings of temperature, humidity, precipitation, and wind conditions across various weather stations in Singapore at intervals of up to one minute.

Learn more about Realtime Weather API at [data.gov.sg/collections/1459/view](https://data.gov.sg/collections/1459/view).
...
This SDK exposes the API as a small set of **semantic entities** — AirTemperature, Collection, Rainfall, RelativeHumidity, WindDirection and WindSpeed — that you
...
| Go CLI | `github.com/voxgig-sdk/realtime-weather-sdk/go-cli` | `go install github.com/voxgig-sdk/realtime-weather-sdk/go-cli/cmd/realtime-weather@latest` |
| Go MCP server | `github.com/voxgig-sdk/realtime-weather-sdk/go-mcp` | `go get github.com/voxgig-sdk/realtime-weather-sdk/go-mcp@latest` |
